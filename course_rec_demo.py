...
if __name__ == "__main__":
    # Use 0.0.0.0 as the host and a default port (e.g., 8000) for Streamlit
    import sys
    if hasattr(sys, 'argv') and any('streamlit' in arg for arg in sys.argv):
        # Already running via streamlit CLI
        pass
    else:
        import os
        os.system("streamlit run course_rec_demo.py --server.address=0.0.0.0 --server.port=8000")
